<template>
        ...
        <div class="book-wrapper">
          <div class="book-list">
            <div class="book-card" v-for="review in visibleReviews" :key="review.bookId">
              ...
              <a @click.prevent="goToBookView(review.bookId)">
  ...
  export default {
    data(this: any): {
      ...
      reviewList: Array<{ bookId: string; bookTitle: string; text: string }>;
      visibleReviews: Array<{ bookId: string; bookTitle: string; text: string }>;
      bookImage: string;
    ...
    created() {
      ...
      // Obtendo o usuário e as reviews ao inicializar o componente
      this.getUserById(this.user.id).then(user => {
        this.user = user;
        this.listReviews();
      });
    }
