...
public class ReviewController {
  ...
  public ResponseEntity<ReviewEntity> updateReview(@PathVariable("id") UUID reviewId,
      @RequestBody ReviewRequestDTO reviewRequest) {
    return reviewService.updateReview(reviewId, reviewRequest);
  }

  @GetMapping("/latest_reviews")
  public ResponseEntity<List<ReviewEntity>> getLatestReviews() {
